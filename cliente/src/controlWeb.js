...
function comprobarUsuario(){
	if($.cookie('usr')){
		var usuarios = rest.obtenerUsuarios();
		var usr = $.cookie('usr');
		console.log(usr);
		if(usuarios[usr.nick]){
...
function mostrarListaJugadores(jugadores) {
	...
	cadena = cadena + "<button type='button' id='preparado' class='btn btn-success' onclick='ws.preparado()'>Preparado</button>";
	cadena = cadena + "<button type='button' id='salirPartida' class='btn btn-primary btn-md'>Salir de la partida</button>";
